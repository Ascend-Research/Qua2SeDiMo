...
def main():
    ...
    parser.add_argument("--q_config", type=str, default='quant_configs/sdxl_37.pkl')
    ...
    aq_params = {'n_bits': 8, 'channel_wise': False, 'scale_method': 'mse', 'leaf_param':  False, 'online_act_quant': False}
    ...
    image = model(prompt=prompts, num_inference_steps=40, denoising_end=0.8,
                    height=opt.res, width=opt.res, output_type="latent").images
