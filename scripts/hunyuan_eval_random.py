...
from bops.annotate_bops_hunyuan import annotate_bops
...
def main():
    ...
    parser.add_argument("--multi_chkpt", type=str, default="multiquantizers/hunyuan_mq.pt")
    ...
    with torch.no_grad():
        model(prompt=["weight calibration prompt"], height=1024, width=1024, num_inference_steps=2)
