import pickle
from bops.attn_bops import attn_bops_pixart_alpha, BOP_LUT, ACT_QUANT_BIT


with open("macs/alpha_512.pkl", "rb") as f:
...
def annotate_bops(d):
    ...
    bops_quant += attn_bops_pixart_alpha(ACT_QUANT_BIT)
