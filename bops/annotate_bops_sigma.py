import pickle
from bops.attn_bops import attn_bops_pixart_sigma, BOP_LUT, ACT_QUANT_BIT


with open("macs/sigma_1024.pkl", "rb") as f:
...
def annotate_bops(d):
    ...
    bops_quant += attn_bops_pixart_sigma(ACT_QUANT_BIT)
